      ...
      <div className="container mx-auto py-4 sm:py-8 px-4">
        ...
        <div className="max-w-4xl mx-auto bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="mb-4 sm:mb-6">
              <label htmlFor="voltage-rating" className="block text-base sm:text-lg font-medium mb-2">
                Voltage Rating
              </label>
              <select
                name="voltageRating"
            ...
            <div className="mb-4 sm:mb-6">
              <label htmlFor="class-type" className="block text-base sm:text-lg font-medium mb-2">
                Class
              </label>
              <select
                name="class"
        ...
        {showOutput && (
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mt-6 sm:mt-10">
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-lg border border-green-100 hover:shadow-xl transition duration-300">
                ...
                <div className="space-y-3 sm:space-y-4 text-gray-800 text-sm sm:text-base lg:text-lg font-medium">
                  <p id="crosssection" className="break-words">• {outputData.crossSection}</p>
                  <p id="wirelength" className="break-words">• {outputData.wireLength}</p>
                  <p id="insulationOnCore" className="break-words">• {outputData.insulationOnCore}</p>
                  <p id="noOfLayers" className="break-words">• {outputData.numOfLayers}</p>

                  <div className="mt-4 sm:mt-6 text-center">
                    <button
                      onClick={handlePrintClick}
                      id="printbtn"
                      className="px-4 sm:px-6 py-2 sm:py-3 rounded bg-gradient-to-t from-green-700 to-green-500 text-white font-bold hover:scale-105 transition-all duration-300 inline-block text-sm sm:text-base"
                    >
                      Print
                    </button>
                  </div>
            ...
            {outputData.predictionResults && (
              <div className="w-full lg:w-1/2">
                <div className="bg-gradient-to-br from-white to-green-50 p-4 sm:p-6 lg:p-8 rounded-2xl shadow-xl border border-green-100 hover:shadow-2xl transition-all duration-500 ease-in-out transform hover:-translate-y-1">
                  <div className="flex items-center justify-center mb-4 sm:mb-6">
                    <BarChart3 className="text-green-600 w-6 h-6 sm:w-7 sm:h-7 mr-2 sm:mr-3" />
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent text-center">
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-4 sm:space-y-5">
                      <div className="bg-gradient-to-r from-green-50 to-white p-3 sm:p-4 rounded-lg shadow-md">
                        <h3 className="font-bold text-lg sm:text-xl text-green-700 mb-2 border-b border-green-100 pb-2">Ratio Errors</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-green-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-green-900 font-medium">At 120% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-green-600">
                              {parseFloat(outputData.predictionResults.Ratio100Error120).toFixed(2)}
                            </span>
                          </div>
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-green-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-green-900 font-medium">At 100% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-green-600">
                              {parseFloat(outputData.predictionResults.Ratio100Error100).toFixed(2)}
                            </span>
                          </div>
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-green-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-green-900 font-medium">At 80% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-green-600">
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-white p-3 sm:p-4 rounded-lg shadow-md">
                        <h3 className="font-bold text-lg sm:text-xl text-blue-700 mb-2 border-b border-blue-100 pb-2">Phase Errors</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-blue-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-blue-900 font-medium">At 120% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-blue-600">
                              {parseFloat(outputData.predictionResults.Phase100Error120).toFixed(2)}
                            </span>
                          </div>
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-blue-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-blue-900 font-medium">At 100% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-blue-600">
                              {parseFloat(outputData.predictionResults.Phase100Error100).toFixed(2)}
                            </span>
                          </div>
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-blue-100 shadow-sm flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                            <span className="text-xs sm:text-sm text-blue-900 font-medium">At 80% Load</span>
                            <span className="text-lg sm:text-2xl font-bold text-blue-600">
                    ...
                    <div className="mt-3 sm:mt-4 text-center">
                      <p className="text-gray-600 text-xs sm:text-sm italic">Values represent predicted error percentages at different loads</p>
                    </div>
                  </div>
                </div>
              </div>
